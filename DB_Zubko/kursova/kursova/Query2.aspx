<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Query2.aspx.cs" Inherits="kursova.Query2" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:KursovaDBConnectionString1 %>" DeleteCommand="DELETE FROM [Route] WHERE [RouteID] = @RouteID" InsertCommand="INSERT INTO [Route] ([StartPoint], [EndPoint], [FirstRace], [LastRace], [Interval]) VALUES (@StartPoint, @EndPoint, @FirstRace, @LastRace, @Interval)" SelectCommand="SELECT * FROM [Route] WHERE ([StartPoint] = @StartPoint) ORDER BY [RouteID]" UpdateCommand="UPDATE [Route] SET [StartPoint] = @StartPoint, [EndPoint] = @EndPoint, [FirstRace] = @FirstRace, [LastRace] = @LastRace, [Interval] = @Interval WHERE [RouteID] = @RouteID">
            <DeleteParameters>
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Залізничний вокзал" Name="StartPoint" Type="String" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="StartPoint" Type="String" />
                <asp:Parameter Name="EndPoint" Type="String" />
